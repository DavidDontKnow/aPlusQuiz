...
const core2QuestionsA = [
    {
        ...
        "answer": "A",
        "reason": "Electrical safety is one of the highest priorities because of its association with personal safety. The tingling sensation is likely due to an electrical grounding issue. Grounding should be tested and verified to ensure proper discharge of electrical currents and to prevent serious hazards."
    },
    {
        ...
        "answer": "A",
        "reason": "The backlight of a mobile phone requires constant battery use, and the phone in an active state will use more battery than one that is locked or in a standby state. Enabling auto-lock would reduce the amount of time the display remains on, thus improving battery life."
    },

    {
        ...
        "answer": "B",
        "reason": "The spooler operates as a background service in Windows. Once the problem is identified and corrected, the spooler service would need to be restarted."
    },
    {
        ...
        "answer": "D",
        "reason": "A cable lock is portable, it can be installed and uninstalled quickly, and it can be wrapped around an existing table or chair to prevent a computer from theft."
    },
    {
        ...
        "answer": "C",
        "reason": "A technician working in an area of dust or debris in the air should use a face mask to prevent any particles in the air from entering their lungs."
    },
    {
        ...
        "answer": "D",
        "reason": "An Apple iOS and iPadOS devices uses both Wi-Fi and Bluetooth to provide location and transfer functionality for AirDrop. Both wireless options should be enabled to use the AirDrop feature."
    },
    {
        ...
        "answer": "D",
        "reason": "For an electrical fire, it's best to use carbon dioxide, FM-200, or other dry chemicals to extinguish any flames."
    },
    {
        ...
        "answer": "D",
        "reason": "BitLocker provides full disk encryption (FDE) for Windows operating system volumes."
    },
    {
        ...
        "answer": "C",
        "reason": "PII (Personally Identifiable Information) is any data which could be used to identify an individual. A name, address, and phone number would be common examples of PII."
    },
    {
        ...
        "answer": "B",
        "reason": "A cloud-based remote backup solution will constantly backup all user data to a remote service. If the device is replaced, all of the user data can be restored directly from this backup in the cloud."
    },

    {
        ...
        "answer": "C",
        "reason": "A surge suppressor can help to even out voltage spikes in an electrical system. It's common to use a surge suppressor at each workstation to limit the effect of these voltage spikes."
    },
    {
        ...
        "answer": "A",
        "reason": "The limited address space of a 32-bit operating system can only support 4 GB of system memory."
    },
    {
        ...
        "answer": "A",
        "reason": "Event Viewer contains a consolidated log of all system and application logs. A technician can use Event Viewer to review all past events on the system."
    },

    {
        ...
        "answer": "A",
        "reason": "A splash screen displays a message, logo, or graphic during the startup process. This screen often contains a legal disclaimer regarding access to the system and information about the data contained in the application."
    },
    {
        ...
        "answer": "D",
        "reason": "UAC (User Account Control) settings are contained in the Control Panel's User Accounts applet."
    },
    {
        "question": "What is the maximum amount of RAM supported by a 32-bit version of an operating system?",
        "choices": {
...

    {
        ...
        "answer": "C",
        "reason": "A brute force attack attempts to determine a user's password by trying every possible combination of letters, numbers, and special characters until the proper combination is found."
    },
    {
        ...
        "answer": "A",
        "reason": "Every planned change needs to have a rollback plan to return the environment to its original state."
    },
    {
        ...
        "answer": "C",
        "reason": "The resources associated with a USB interface can vary based on the interface type and USB controller version. If these resources are exceeded on a USB controller, the system will display a message explaining the lack of resources."
    },
    {
        ...
        "answer": "A",
        "reason": "The easiest and most efficient way for technicians to access the drive share is to map a drive letter to the share and transfer the files directly."
    },
    {
        ...
        "answer": "A",
        "reason": "The latest version of Windows 10 x64 requires a minimum of 32 GB free storage space."
    },
    {
        ...
        "answer": "A",
        "reason": "A rootkit is a type of malware that modifies core system files and can be invisible to the operating system. In this example, malware that runs as part of the kernel and can't be seen by traditional anti-malware is a rootkit."
    },
    {
        ...
        "answer": "C",
        "reason": "Before making any changes to the operating system or application software, it would be useful to know if power cycling the tablets would have an effect. If the symptom was to disappear after the restart, then no immediate changes would be required."
    },
    {
    ...
    },
    {
        ...
        "answer": "B",
        "reason": "Although 32-bit applications will run on a 64-bit operating system, the reverse is not true. A 64-bit application will require a 64-bit operating system to work."
    },
    {
        ...
        "answer": "D",
        "reason": "Using someone else to gain access to a building or through a locked door is tailgating."
    },
    {
        ...
        "answer": "A",
        "reason": "The nano utility is a full-screen text editor that can be used from the command line of a Linux device."
    },
    {
        "question": "An internal audit has found that a server in the DMZ appears to be infected with malware. The malware does not appear to be part of a file in the OS, and the malware is started each time the system is started. What type of malware would be MOST likely found on this server?",
        "choices": {
            "A": "Trojan",
            "B": "Ransomware",
            "C": "Keylogger",
        ...
        "answer": "E",
        "reason": "A boot sector virus modifies the boot sector of the drive, so the malicious software is started each time the computer is booted."
    },
    {
        "question": "A user has delivered a broken laptop to the help desk, and they are visibly upset and quite vocal about the problem they're having. The user is also asking for a very specific repair that doesn't appear to have any relationship to their issue. What's the best way to handle this situation?",
        "choices": {
        ...
        "answer": "A",
        "reason": "The best response in a stressful situation is to listen, ask questions, and refrain from arguing or acting defensive. The technician should focus on resolving the issue."
    },
    {
        "question": "Daniel, a user in the finance department, has purchased a new Android smartphone and installed a number of productivity apps. After a day of use, Daniel finds the phone displaying a large number of advertisements when browsing the Internet. Which of the following tasks should Daniel perform after completing a factory reset?",
        "choices": {
            "A": "Disable Bluetooth",
        ...
        "answer": "D",
        "reason": "It's a best practice to check the legitimacy of each app installed onto a smartphone to avoid installing malware that may display unwanted ads."
    },
    {
    ...
    },
    {
        ...
        "answer": "E",
        "reason": "MFA (Multi-factor Authentication) adds an additional layer of security, in this case, with a hardware token providing a constantly changing code."
    },
    {
        ...
        "answer": "C",
        "reason": "Task Manager includes a Startup tab for managing applications that launch during the Windows login process."
    },
    {
        ...
        "answer": "C",
        "reason": "The first step when working inside of a computer or printer is to remove all power sources."
    },
    {
        ...
        "answer": "C",
        "reason": "A regular format overwrites each sector of the drive, making the previous data unrecoverable."
    },
    {
        ...
        "answer": "A",
        "reason": "The 'cd' command (change directory) is used to navigate to a folder in both Windows and Linux environments."
    },
    {
        ...
        "answer": "D",
        "reason": "The GPT (GUID Partition Table) partition style allows for up to 128 separate bootable partitions."
    },
    {
        ...
        "answer": "A",
        "reason": "The Windows installation program includes drivers for most hardware devices, but occasionally additional device drivers will need to be added during the installation process."
    },
    {
        ...
        "answer": "C",
        "reason": "A system running slowly and with files randomly disappearing are clear indications of malware. Installing anti-malware software is the best step to identify and remove any existing malware."
    },
    {
        ...
        "answer": "B",
        "reason": "To upgrade, a smartphone needs enough storage available to download and process the upgrade files. If the storage space is limited, the upgrade will not be processed."
    },
    {
        ...
        "answer": "C",
        "reason": "The built-in backup and restore utility in macOS is called Time Machine."
    },
    {
        ...
        "answer": "C",
        "reason": "Personally licensed software may not be allowed on company-owned systems if the company has not purchased the license."
    },
    {
        ...
        "answer": "C",
        "reason": "A clean install of Windows 11 will completely delete the previous operating system and install a new version. This is ideal when no documents or settings need to be retained."
    },
    {
        ...
        "answer": "A",
        "reason": "The first step is to quarantine the system to prevent any malware from spreading. Disconnecting the network cable is an important step in this process."
    },
    {
        ...
        "answer": "C",
        "reason": "Communication is key in situations like these. It's important to inform the user about the repair status and any delays."
    },
    {
        ...
        "answer": "C",
        "reason": "A Windows upgrade that maintains applications and settings requires the destination version to be the same Windows edition or higher. In this case, Windows 10 Enterprise x64 is the correct choice."
    },
    {
        ...
        "answer": "B",
        "reason": "The Windows Event Viewer can provide extensive logs and information about the system and the applications running in Windows."
    },
    {
        ...
        "answer": "B",
        "reason": "Delays during the boot process can be caused by a single application install creating issues, so disabling startup applications is a straightforward step in troubleshooting."
    },
    {
        ...
        "answer": "C",
        "reason": "The Administrator account is the superuser of a Windows device. Installing an application that modifies system files or installs a service requires Administrator access."
    },
    {
        ...
        "answer": "C",
        "reason": "Remote users commonly connect to the corporate office over a VPN. If the VPN link is inactive, the user cannot access resources at the corporate office, including printers."
    },
    {
        ...
        "answer": "B",
        "reason": "For users connected over the network, Windows share permissions are used in addition to NTFS permissions to control access. It's likely the share permissions include additional restrictions."
    },
    {
        ...
        "answer": "D",
        "reason": "Physically shredding the drives guarantees all data is unrecoverable, which meets the security requirements for disposal."
    },
    {
        ...
        "answer": "D",
        "reason": "It's important to evaluate the urgency of the issue. Contacting the end-user to determine the importance of the repair ensures the technician addresses critical issues in a timely manner."
    },
    {
        ...
        "answer": "A",
        "reason": "After disabling System Restore, the next step is remediation. Updating the anti-virus signatures ensures the technician can identify and remove malware with the latest definitions."
    },
    {
        ...
        "answer": "C",
        "reason": "SSH (Secure Shell) provides encrypted console communication, making it the best choice for managing network devices like switches and firewalls."
    },
    {
        ...
        "answer": "C",
        "reason": "Fake security warnings are a strong indication of malware. Running an anti-malware scan is the best way to identify and resolve this issue."
    },
    {
        ...
        "answer": "D",
        "reason": "If the BIOS is configured to boot from a USB interface prior to the internal storage drive, any bootable flash drive would be used as a boot device. Modifying the BIOS boot order ensures the system boots from the internal drive first."
    },
    {
        ...
        "answer": "D",
        "reason": "Adware is a type of malware that forces advertisements to appear on a user's desktop. Removing the malware and restoring the system from a known good backup is necessary."
    },
    {
        ...
        "answer": "D",
        "reason": "The .bat file extension refers to Windows batch files. The 'cd' command and reference to the drive letter 'c:' are common in Windows batch files."
    },
    {
        ...
        "answer": "C",
        "reason": "The sfc (System File Checker) command is used to scan and replace any missing or corrupted core operating system files. It is commonly run after removing malware."
    },
    {
        ...
        "answer": "D",
        "reason": "When a security incident occurs, it's important to securely collect and store any evidence. The computer used to share copyrighted materials should be collected and stored until proper authorities can take control of it."
    },
    {
        ...
        "answer": "D",
        "reason": "Group Policy in Active Directory is the centralized management feature that allows administrators to define desktop and security policies, including password complexity."
    },
    {
        ...
        "answer": "B",
        "reason": "Windows shares ending with a dollar sign ($) are hidden from normal browsing but can still be accessed if the user knows the share name."
    },
    {
        ...
        "answer": "D",
        "reason": "Since wireless network names are visible, but Jack is not connected to a network, it's most likely that the authentication process failed due to an incorrect Wi-Fi password."
    },
    {
        ...
        "answer": "B",
        "reason": "An anti-static strap helps prevent electrostatic discharge (ESD), which can damage sensitive components inside the computer when replacing or upgrading hardware."
    },
    {
        ...
        "answer": "B",
        "reason": "Asset tags are used to track equipment within an organization. They allow the company to manage and track the location of devices as they are moved or serviced."
    },
    {
        ...
        "answer": "D",
        "reason": "With extensions hidden, it's difficult to know the type of file based only on the filename. A file named 'Monthly Orders' might be a spreadsheet or it could be an executable containing a virus."
    },
    {
        ...
        "answer": "D",
        "reason": "The last step in the change control process is to get end-user acceptance and sign-off on the changes made."
    },
    {
        ...
        "answer": "B",
        "reason": "The gpupdate command forces centralized updates, such as password policy changes, to be activated on target devices."
    },
    {
        ...
        "answer": "C",
        "reason": "Disabling System Restore prevents the malware from reinfecting the system through existing restore points."
    },
    {
        ...
        "answer": "B",
        "reason": "A UPS (Uninterruptible Power Supply) provides short-term battery backup during power outages."
    },
    {
        ...
        "answer": "A",
        "reason": "Full device encryption ensures that all data on the tablet is protected, even if the device is lost or stolen."
    },
    {
        ...
        "answer": "A",
        "reason": "The Disk Management utility provides a graphical overview of the disk configuration, status, and free space."
    },
    {
        ...
        "answer": "D",
        "reason": "The Event Viewer can provide detailed information about events leading up to the system lock-up, aiding in troubleshooting."
    },
    {
        ...
        "answer": "B",
        "reason": "A remote network installation allows for simultaneous upgrades on multiple systems, making it the most efficient method."
    },
    {
        ...
        "answer": "D",
        "reason": "After malware has been removed and the system is protected, it is important to educate the end user on preventing future issues and when to seek support."
    },
    {
        ...
        "answer": "D",
        "reason": "An air filter mask is essential for protecting the lungs from toner particles during the cleaning process."
    },
    {
        ...
        "answer": "B",
        "reason": "Restoring the system from a known good backup ensures that all malware is removed, resolving the pop-up and connectivity issues."
    },
    {
        ...
        "answer": "A",
        "reason": "Keeping the OS patched is critical to prevent vulnerabilities when external access is allowed to the server."
    },
    {
        ...
        "answer": "D",
        "reason": "The sudo command grants the necessary superuser permissions to execute administrative tasks such as upgrading software."
    },
    {
        ...
        "answer": "A",
        "reason": "The Power Options in the Control Panel allow configuration changes for the behavior when closing the laptop lid."
    },
    {
        ...
        "answer": "E",
        "reason": "MAC filtering allows or denies network access based on the hardware address of the wireless adapter, making it suitable for excluding specific devices."
    },
    {
        ...
        "answer": "C",
        "reason": "Starting in VGA mode allows access to the system, where the problematic video driver can be rolled back."
    },
    {
        ...
        "answer": "D",
        "reason": "The user's account should be disabled to quarantine the system and prevent further network access until the issue is resolved."
    },
    {
        ...
        "answer": "A",
        "reason": "WPA3 provides the highest level of wireless encryption and is considered the most secure method for protecting data over the network."
    },
    {
        "question": "A technician is troubleshooting a computer infected with a virus. The user thought they were opening a spreadsheet, but the file was actually a virus executable. Which of the following Windows options were MOST likely associated with this issue?",
        "choices": {
...
const core2QuestionsB = [
    {
        ...
        "answer": "A",
        "reason": "A regular format in Windows will overwrite each sector with zeros, preventing data recovery."
    },
    {
        ...
        "answer": "A",
        "reason": "The toner in laser printer cartridges can be harmful, so it's important to dispose of the cartridges at a local hazardous waste facility."
    },
    {
        ...
        "answer": "B",
        "reason": "The net use command will assign a local drive letter to a network share."
    },
    {
        ...
        "answer": "D",
        "reason": "Time Machine is the backup utility included with macOS and creates backups automatically."
    },
    {
        ...
        "answer": "C",
        "reason": "An ESD strap prevents damage from static electricity by grounding the user to the equipment."
    },
    {
        "question": "A desktop administrator is upgrading an older computer to support the 64-bit version of Windows 10 Pro. The computer currently has: 1 GHz CPU, 1 GB of RAM, 50 GB of free storage space, and 1024 x 768 video resolution. Which of the following should be upgraded to support the Windows 10 installation?",
        "choices": {
            "A": "CPU",
            "B": "RAM",
            "C": "Storage space",
        ...
        "answer": "B",
        "reason": "The 64-bit version of Windows 10 requires a minimum of 2 GB of system memory. Since this system only has 1 GB of RAM, it will need an upgrade to install Windows 10 x64."
    },
    {
        ...
        "answer": "D",
        "reason": "It's important to keep an open line of communication with the end user, especially if delays occur. This allows the user to make alternate plans if needed."
    },
    {
        ...
        "answer": "D",
        "reason": "The dir command lists files from the command line, and it includes filtering options like 'dir *.log' to find files with a specific extension."
    },
    {
        ...
        "answer": "B",
        "reason": "A slow download usually indicates a network issue, so running a network speed check would provide insight into the connectivity problem."
    },
    {
        ...
        "answer": "D",
        "reason": "The Device Manager allows administrators to enable, disable, and manage hardware drivers, including USB controllers."
    },
    {
        ...
        "answer": "C",
        "reason": "Power cycling the phone is a non-invasive first troubleshooting step that resets the operating system, which may resolve the issue before making any configuration or app changes."
    },
    {
        ...
        "answer": "C",
        "reason": "Maintaining a chain of custody ensures that the data is not tampered with or altered, which is critical for legal investigations and data integrity."
    },
    {
        ...
        "answer": "B",
        "reason": "Educating the end-user on best practices to avoid malware could prevent future infections. This is often a crucial step in malware removal that may have been missed."
    },
    {
        ...
        "answer": "B",
        "reason": "Domain access is only available in Windows 10 Pro, allowing devices to be connected to a corporate network domain."
    },
    {
        ...
        "answer": "C",
        "reason": "Full disk encryption ensures that all data on the laptop is protected, making it inaccessible even if the laptop is lost or stolen."
    },
    {
        ...
        "answer": "A",
        "reason": "EFS (Encrypting File System) allows users to encrypt individual files or groups of files without encrypting the entire drive."
    },
    {
        ...
        "answer": "D",
        "reason": "A cloud backup service provides automatic backups throughout the day, ideal for a user who travels frequently."
    },
    {
        ...
        "answer": "B",
        "reason": "An anti-static bag protects the SSD from electrostatic discharge during transport."
    },
    {
        ...
        "answer": "C",
        "reason": "A browser hijack is likely caused by malware. Running a malware removal utility can resolve the issue."
    },
    {
        ...
        "answer": "A",
        "reason": "Since the phone works fine at the office, the issue likely lies with the user's home network configuration."
    },
    {
        ...
        "answer": "C",
        "reason": "A clean install ensures that all malware, including rootkits, is completely removed by reinstalling the operating system from scratch."
    },
    {
        ...
        "answer": "B",
        "reason": "WPA3 adds password protection to ensure that only authorized users can connect to the company's network."
    },
    {
        ...
        "answer": "A",
        "reason": "Renaming the user's folder and deleting their profile from the registry will reset the profile and resolve the issue caused by a corrupted user profile."
    },
    {
        ...
        "answer": "B",
        "reason": "An expired website certificate is the most likely reason for all systems being unable to connect securely to the third-party website."
    },
    {
        ...
        "answer": "B",
        "reason": "Disabling the auditor accounts between audits prevents them from logging into the system when they are not needed."
    },
    {
        ...
        "answer": "B",
        "reason": "A regular format will overwrite every sector with zeros, ensuring that recovery software cannot restore any data on the drive."
    },
    {
        ...
        "answer": "D",
        "reason": "A UPS (Uninterruptible Power Supply) protects the workstation from power outages and allows continued operation during brief power interruptions."
    },
    {
        ...
        "answer": "A",
        "reason": "The defragmentation utility reorganizes fragmented files, improving the overall read and write times on the hard drive."
    },
    {
        ...
        "answer": "D",
        "reason": "Running an anti-malware utility is the best next step to determine if malware is causing the false security alert."
    },
    {
        ...
        "answer": "C",
        "reason": "Modifying the default permissions limits the access a Trojan horse would have if it compromises a user's account, reducing the potential damage."
    },
    {
        ...
        "answer": "B",
        "reason": "Using a remote network installation allows multiple systems to be imaged simultaneously without requiring separate installation media, making it an efficient deployment method."
    },
    {
        ...
        "answer": "D",
        "reason": "In Windows, the 'Deny' permission takes priority over all other permissions. If a user is denied access, it will override any 'Allow' permissions that may be set."
    },
    {
        ...
        "answer": "A",
        "reason": "An electrical ground safely diverts electrical faults away from people, protecting them from electrical hazards."
    },
    {
        ...
        "answer": "B",
        "reason": "The caller is using social engineering techniques to deceive the user into revealing sensitive information."
    },
    {
        ...
        "answer": "A",
        "reason": "After malware removal, System Protection should be re-enabled to allow the creation of restore points, which had been disabled during the cleanup process."
    },
    {
        ...
        "answer": "A",
        "reason": "RADIUS is commonly used to authenticate remote users with a centralized database like Active Directory, providing secure access via VPN."
    },
    {
        ...
        "answer": "D",
        "reason": "MBR is an older partition style that limits partitions to a maximum size of 2 TB."
    },
    {
        ...
        "answer": "C",
        "reason": "After successfully deploying the changes, the next step in change management is to document the updates for future reference and to ensure proper record keeping."
    },
    {
        ...
        "answer": "D",
        "reason": "A knowledge base typically contains technical documentation and procedures that would assist with rebuilding the email server."
    },
    {
        ...
        "answer": "D",
        "reason": "GPT is a partition style that supports larger volumes and would allow the creation of a 4 TB partition, whereas MBR and FAT32 have limitations on partition size."
    },
    {
        ...
        "answer": "D",
        "reason": "High CPU usage, random pop-ups, and intermittent network issues are clear indicators of a malware infection."
    },
    {
        ...
        "answer": "A",
        "reason": "Since the OS upgrade was the most recent change and the tablet worked fine before, a faulty OS upgrade is the most likely cause."
    },
    {
        ...
        "answer": "B",
        "reason": "File Explorer hides certain system files by default. Adjusting the 'File Explorer Options' to show hidden files would make the directory visible."
    },
    {
        ...
        "answer": "B",
        "reason": "The 'mv' command in Linux is used to move or rename files, making it the best option for renaming the log file."
    },
    {
        ...
        "answer": "D",
        "reason": "Disconnecting the laptop from the network is the first step to quarantine the system and prevent the malware from spreading."
    },
    {
        ...
        "answer": "A",
        "reason": "Disabling startup items will help reduce the memory utilization and improve system performance until a more permanent solution is implemented."
    },
    {
        ...
        "answer": "D",
        "reason": "RDP (Remote Desktop Protocol) is integrated into Windows and allows for full control of a remote desktop."
    },
    {
        ...
        "answer": "C",
        "reason": "Turning off Fast Startup in the Control Panel Power options allows the technician to regain access to BIOS startup hotkeys."
    },
    {
        ...
        "answer": "B",
        "reason": "The random movement and application opening are clear signs of a malware infection. Running an anti-virus scan is the best step to detect and remove malware."
    },
    {
        ...
        "answer": "B",
        "reason": "The change board must evaluate and approve the proposed change before it can be implemented. Since the risk analysis was completed late, the change board couldn't approve the upgrade in time."
    },
    {
...

    {
        ...
        "answer": "A",
        "reason": "A remote network installation allows for unattended installations while users are away from their desks, making it the best choice."
    },
    {
        ...
        "answer": "C",
        "reason": "The first step in troubleshooting would be to check if the system meets the requirements of the new application, as it may require more resources."
    },
    {
...

    {
        ...
        "answer": "B",
        "reason": "Smartphone batteries degrade over time, and after three years, the battery capacity has likely decreased, leading to shorter battery life."
    },
    {
        ...
        "answer": "C",
        "reason": "After removing malware, scheduling periodic anti-virus scans helps ensure the system stays protected and identifies future threats."
    },
    {
...

    {
        ...
        "answer": "B",
        "reason": "The Event Viewer logs contain detailed information on system and application errors, making it the best next step in troubleshooting."
    },
    {
        ...
        "answer": "A",
        "reason": "This is a classic phishing attack, where the attacker tries to deceive the user into providing sensitive information through a fake payment site."
    },
    {
        ...
        "answer": "B",
        "reason": "Contacting the customer for more details helps clarify the issue, allowing for more focused and efficient troubleshooting."
    },
    {
        ...
        "answer": "B",
        "reason": "Linux is a free and open-source operating system developed by a community of contributors, unlike the proprietary systems listed."
    },
    {
        ...
        "answer": "A",
        "reason": "A daily file-level backup provides users with the option to recover previous versions of their documents as needed."
    },
    {
        ...
        "answer": "C",
        "reason": "Violations of the Acceptable Use Policy (AUP) should be escalated to the company's security officer to handle any necessary actions or investigations."
    },
    {
        ...
        "answer": "A",
        "reason": "Microsoft Visual Basic Scripting (.vbs) is commonly used for automating tasks within Microsoft Office applications."
    },
    {
        ...
        "answer": "C",
        "reason": "A Windows Workgroup allows for file sharing between computers in a small network, which is ideal for a small office home office (SOHO) setup."
    },
    {
        ...
        "answer": "A",
        "reason": "The most likely security concern is that cloud storage services may have inadvertently made the product photos accessible to unauthorized users."
    },
    {
        ...
        "answer": "B",
        "reason": "Managing credit card transactions is critical due to the strict regulations and standards for payment card information in the Payment Card Industry Data Security Standard (PCI DSS)."
    },
    {
        ...
        "answer": "A",
        "reason": "Configuring a VPN ensures that any communication from the user's phone is encrypted, maintaining the privacy of messages sent over the wireless network."
    },
    {
        ...
        "answer": "B",
        "reason": "WPA3 is the most secure encryption standard for wireless networks, offering the best security for the new access point."
    },
    {
        ...
        "answer": "D",
        "reason": "Performing occasional recovery tests ensures that the backup data can be successfully restored and confirms the reliability of the backup process."
    },
    {
        ...
        "answer": "D",
        "reason": "The System utility in Control Panel includes settings for configuring Remote Desktop access, making it the correct feature to use."
    },
    {
        ...
        "answer": "C",
        "reason": "Repeating an understanding of the issue back to the customer ensures that the problem is correctly documented and helps verify the details before proceeding with troubleshooting."
    },
    {
        ...
        "answer": "D",
        "reason": "The first step in working inside a computer should always be to disconnect the system from the power source to ensure safety."
    },
    {
        ...
        "answer": "C",
        "reason": "Installing the application to a network share can bypass the local storage limitations, allowing the installation to complete successfully."
    },
    {
        ...
        "answer": "A",
        "reason": "Open-source software is typically free and doesn't require a monthly subscription, making it the best choice for the user."
    },
    {
        ...
        "answer": "C",
        "reason": "Task Manager provides real-time information on memory usage, making it the best tool for identifying applications using excessive RAM."
    },
    {
        ...
        "answer": "D",
        "reason": "Running Startup Repair from the Advanced Boot Options can resolve issues that cause reboot loops, without requiring a full reinstall."
    },
    {
        ...
        "answer": "B",
        "reason": "A simple browser add-on shouldn't require administrative permissions. The UAC prompt indicates that the software may be a Trojan horse attempting to make significant changes to the system."
    },
    {
        ...
        "answer": "C",
        "reason": "When the corporate VPN is enabled and all traffic is routed through it, users may lose access to local home resources such as printers and shared drives."
    },
    {
        ...
        "answer": "A",
        "reason": "Slower load times, application sluggishness, and failed updates are common symptoms of a malware infection, making an anti-malware scan the best next step."
    },
    {
        ...
        "answer": "A",
        "reason": "Performance Monitor tracks system utilization over time, including CPU, memory, and network performance, making it the best tool to track spikes in system usage."
    },
    {
        ...
        "answer": "C",
        "reason": "Changing the default password on a router prevents unauthorized users from accessing and modifying the router’s configuration, such as default routes."
    }
]



// let combinedQuestions = core2QuestionsA.concat(core2QuestionsB);
...
document.addEventListener("DOMContentLoaded", hideNextButton);

coreSelect.addEventListener("click", e => {
    switch (e.target.innerText) {
        case "Core 1":
            coreSelect.innerText = "Core 2";
            combinedQuestions = core2QuestionsA.concat(core2QuestionsB);
            init();
            break;
        case "Core 2":
            coreSelect.innerText = "Core 1";
            combinedQuestions = core1QuestionsA.concat(core1QuestionsB);
            init();
            break;
    }
});
